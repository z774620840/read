...
<body>
	<div id="topbar">
		<div id="TopSection">
			...
			<div id="topbarnav">
				<span class="topnavitems"><a href="register.html">注册</a> | <a href="3">登录
				</a></span>
				<form action="#">
			...
			<div class="clear"></div>
			<ul id="topmenu">
				<li class="active"><a href="bookindex.html">首页</a></li>
	...
	<div id="wrap">
		<div id="header">
			<h2 class="introtext">
			<span class="highlight2">Reading</span> is to the mind what exercise it to the body
		...
		<div id="contents">
			...
			<div id="aboutdiv">
				<h2>What ?</h2>
				<p>
					<span class="openquote"></span>Imagination is a free css template
					or rather a complete css website suitable for Magazines, Business
					Websites or even Blogs <img src="images/quote2.gif"
						alt="Closing Quote" />
				</p>
				<h2>About Us</h2>
				<p>
					<span class="openquote"></span>Nam ultrices euismod dolor. Donec
					rutrum felis et mauris. Vestibulum nisl. Ut ultrices. Nunc
					adipiscing est ultrices augue. Aliquam commodo<img
						src="images/quote2.gif" alt="Closing Quote" />
				</p>
			</div>
			<div id="highlights">
				<h2>What's New?</h2>
				<ul>
					<li><h3>
						...
						</h3> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Integer
						ac orci. Vestibulum rutrum. Praesent a lectus.</li>
					<li><h3>
							<a href="#">Lorem Ipsum</a>
						</h3> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Integer
						ac orci. Vestibulum rutrum. Praesent a lectus.</li>
			...
			<div id="homecontents">
				...
				<span class="postinfo">By Lorem I. Dolor</span>
				<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
					Integer ac orci. Vestibulum rutrum. Praesent a lectus. Nam ultrices
					euismod dolor. Donec rutrum felis et mauris. Vestibulum nisl. Ut
					ultrices. Nunc adipiscing est ultrices augue. Aliquam commodo. Ut
